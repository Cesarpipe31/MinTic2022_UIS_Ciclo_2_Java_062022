...
public class Producto {
    ...
    public boolean guardarProducto()
    {
        ...
        String SQL = "INSERT INTO clientes(nombre,id,temperatura,valorbase) VALUES('"+this.nombre+"',"+this.id+",'"+this.temperatura+"','"+this.valorBase+"');";
    ...
    public boolean actualizarProducto(){
        ...
        ConexionBD miconexion = new ConexionBD();
        String SQL = "UPDATE productos SET nombres='"+this.nombre+"', id='"+this.id+"' WHERE temperatura='"+this.temperatura+"' AND valorBase="+this.valorBase+";";
        if(miconexion.setAutoCommitBD(false)==true){
    ...
    public boolean borrarProducto(){
        ...
        ConexionBD miconexion = new ConexionBD();
        String SQL = "DELETE FROM producto WHERE nombre='"+this.nombre+"' AND id="+this.id+";";
        if(miconexion.setAutoCommitBD(false)==true){
