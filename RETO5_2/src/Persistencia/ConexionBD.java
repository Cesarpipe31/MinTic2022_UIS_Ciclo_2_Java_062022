...
public class ConexionBD {
    ...
    final String NombreBD = "Producto.db"; //CAMBIE AQUI EL NOMBRE DE LA BASE DE DATOS, DEBE ESTAR EN LA CARPETA RAIZ
    ...
    public ConexionBD()
    {
        ...
        try
        {
            ...
            if(miconexion != null)
            {
                ...
                System.out.println("¡ Miledis La Base de datos " + NombreBD + " se conectó exitosamente! Driver utilizado: " + metadata.getDriverName());
            }
        }
